...
<html>
    <head>
        ...
        <!-- Daterange picker -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>adminlte2/plugins/daterangepicker/daterangepicker.css">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="<?php echo base_url(); ?>adminlte2/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <img src="<?php echo base_url(); ?>adminlte2/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                                    </div>
                                                    <h4>
                                                        Developers
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <?php
                        // data main menu
                        $main_menu = $this->db->get_where('dinamis_menu', array('is_main_menu' => 0));
                        foreach ($main_menu->result() as $main) {
                            // Query untuk mencari data sub menu
                            $sub_menu = $this->db->get_where('dinamis_menu', array('is_main_menu' => $main->id));
        ...
        <!-- FastClick -->
        <script src="<?php echo base_url(); ?>adminlte2/plugins/fastclick/fastclick.js"></script>
        <!-- AdminLTE App -->
